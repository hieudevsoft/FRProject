...
class FragmentPet : BaseFragment<FragmentPetBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ibBack.setOnClickWithAnimationListener {
            authAndProfileViewModel.updateAdditionalInformation(prefs.readIdUserLogin()!!,"pet",currentPositionChoose)
        }
            ...
            authAndProfileViewModel.stateAdditionalInformation.collect {
                when (it) {
                    ...
                    is ResourceRemote.Success -> {
                        ...
                        sharedViewModel.setSharedFlowPet(currentPositionChoose)
